        ...
        children: [
          InkWell(
            ...
            onDoubleTap: () async {
              ...
              if (widget.workoutlRef!.mealFavorites
                  .contains(currentUserReference)) {
                logFirebaseEvent('Container_haptic_feedback');
                HapticFeedback.lightImpact();
                logFirebaseEvent('Container_backend_call');

                await widget.workoutlRef!.reference.update({
                  ...mapToFirestore(
                    {
                      'meal_favorites':
          ...
          Padding(
            ...
            child: Text(
              widget.workoutlRef!.mealName.maybeHandleOverflow(
                maxChars: 36,
                replacement: '…',
              ),
              maxLines: 2,
          ...
          if (widget.workoutlRef!.mealDiet.isNotEmpty)
            Padding(
