...
class _SignInWidgetState extends State<SignInWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => setState(() {
          _model.emailAddressController?.text = 'IlayLevi@email.com';
                        ...
                        child: Stack(
                          children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'SIGN_IN_PAGE_Column_e7vtiy6t_ON_TAP');
                                logFirebaseEvent('Column_alert_dialog');
                                await showDialog(
                                  context: context,
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: const Text('בבנייה'),
                                      content: const Text('חלק זה עדיין תחת עבודה'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                              Navigator.pop(alertDialogContext),
                                          child: const Text('טוב'),
                                        ),
                                      ],
                                    );
                                  },
